  ...
  return (
    <div>
      <div>
        ...
        <p className="text-primary/75 text-base mb-4">You canfill inthe following form for customer care</p>
      ...
      <div className="mt-20">
        ...
        <input type ="submit" value={"Uploadyou resume"} className="w-full block py-2 pl-3 border focus:outline-none bg-blue rounded-sm text-white cursor-pointer font-semibold"/> 
        </div>
